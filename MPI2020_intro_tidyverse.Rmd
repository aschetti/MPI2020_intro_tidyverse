...
This plot shows that negative imagery may have influenced ratings to water more than to beer. 
...
**BONUS**: recreate plot #2 using the [```yarrr```](https://cran.r-project.org/web/packages/yarrr/vignettes/pirateplot.html) package
