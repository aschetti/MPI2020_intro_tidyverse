...
It is time to install the first package of this session: ```here```. For a brief overview of what the package can do, see [this GitHub repository](https://github.com/jennybc/here_here) (authored by Jenny Bryan!).

```{r setup_install_here, eval = FALSE}
